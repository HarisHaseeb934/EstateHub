...
const page = () => {
  ...
  return (
    <main>
      ...
      <PropertiesSection
        variant="sale"
        properties={rentPropertiesData}
        description="Explore our handpicked properties for sale and find the perfect space to call your own. Quality homes. Great locations. Better living."
      />
